...
- Post-v0.8.30 sweep: paginated Supabase Storage mirror list (200+ artifacts); local `GET /api/mirror` aggregates all profile prefixes like hosted; import dialog scopes artifacts to active profile; README paid-tier cloud sync line updated.
