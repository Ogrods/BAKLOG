...
PROVIDERS: dict[str, ProviderSpec] = {
    ...
    "ea": ProviderSpec(
        ...
        tips=(
            ...
            "After sign-in we'll open EA's deals page to confirm your session, then save the profile.",
            "Each sync replays your own ea.com login locally \u2014 the same request your browser makes.",
