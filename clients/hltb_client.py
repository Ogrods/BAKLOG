...
class HltbClient:
    ...
    def lookup(self, game_name: str) -> dict | None:
        ...
        return {
            ...
            "hltb_main_hours": _to_hours(best.main_story),
            "hltb_main_extra_hours": _to_hours(best.main_extra),
            "hltb_completionist_hours": _to_hours(best.completionist),
            "hltb_match_confidence": round(confidence, 3),
        }
