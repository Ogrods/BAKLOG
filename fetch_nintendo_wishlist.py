...
def _load_existing() -> dict[str, dict]:
    if not GAMES_NINTENDO_WISHLIST_JSON.exists():
        return {}
    try:
        data = json.loads(GAMES_NINTENDO_WISHLIST_JSON.read_text(encoding="utf-8"))
    except json.JSONDecodeError:
        return {}
...
def main() -> int:
    ...
    GAMES_NINTENDO_WISHLIST_JSON.write_text(
