...
def library_authoritative(*extra):
...
AMAZON = library_authoritative(
    "amazon_id", "amazon_entitlement_id", "amazon_adg_id", "asin", "product_line", "publisher", "source"
)
...
NINTENDO = library_authoritative(
    ...
    "vgc_id",
    "nintendo_platform",
    "nintendo_apparent_platform",
    "nintendo_icon_url_standard",
    "nintendo_icon_sizes",
    "nintendo_device_type",
    "nintendo_content_type",
    "nintendo_is_dlc",
    "publisher",
    "nintendo_is_lending",
    "nintendo_is_partial_lending",
    "nintendo_lending_expire",
    "nintendo_has_application",
    "nintendo_has_addon_contents",
    "nintendo_has_upgrade",
    "nintendo_has_nx_application",
    "nintendo_has_nx_addon_contents",
    "nintendo_has_ounce_application",
    "nintendo_has_ounce_addon_contents",
    "nintendo_contains_released",
    "nintendo_ownership_source",
