...
AUTH_PROVIDER_BY_KEY: dict[str, str] = {'steam': 'steam', 'gog': 'gog', 'psn': 'psn', 'epic': 'epic', 'amazon': 'amazon', 'xbox': 'xbox', 'battlenet': 'battlenet', 'ubisoft': 'ubisoft', 'nintendo': 'nintendo', 'itch': 'itch', 'humble': 'humble', 'ea': 'ea', 'wishlistSteam': 'steam', 'wishlistGog': 'gog', 'wishlistEpic': 'epic_wishlist', 'wishlistPsn': 'psn', 'wishlistUbisoft': 'ubisoft', 'wishlistXbox': 'xbox_wishlist', 'wishlistNintendo': 'nintendo_wishlist', 'wishlistHumble': 'humble', 'itad': 'itad'}
LIBRARY_JSON_BY_KEY: dict[str, str] = {'steam': 'games_steam.json', 'gog': 'games_gog.json', 'psn': 'games_psn.json', 'epic': 'games_epic.json', 'amazon': 'games_amazon.json', 'nintendo': 'games_nintendo.json', 'itch': 'games_itch.json', 'xbox': 'games_xbox.json', 'battlenet': 'games_battlenet.json', 'ubisoft': 'games_ubisoft.json', 'humble': 'games_humble.json', 'ea': 'games_ea.json'}
WISHLIST_JSON_BY_KEY: dict[str, str] = {'wishlistSteam': 'games_wishlist.json', 'wishlistGog': 'games_wishlist_gog.json', 'wishlistEpic': 'games_wishlist_epic.json', 'wishlistPsn': 'games_wishlist_psn.json', 'wishlistUbisoft': 'games_wishlist_ubisoft.json', 'wishlistXbox': 'games_wishlist_xbox.json', 'wishlistNintendo': 'games_wishlist_nintendo.json', 'wishlistHumble': 'games_wishlist_humble.json'}
WISHLIST_META_KEY_BY_FETCHER: dict[str, str] = {'wishlistSteam': 'wishlist', 'wishlistGog': 'wishlistGog', 'wishlistEpic': 'wishlistEpic', 'wishlistPsn': 'wishlistPsn', 'wishlistUbisoft': 'wishlistUbisoft', 'wishlistXbox': 'wishlistXbox', 'wishlistNintendo': 'wishlistNintendo', 'wishlistHumble': 'wishlistHumble'}
...
def export_js_registry(out_path: Path | None=None) -> None:
    ...
    payload = {'libraryStoreJson': LIBRARY_JSON_BY_KEY, 'wishlistFetcherJson': WISHLIST_JSON_BY_KEY, 'wishlistFetcherMetaKey': WISHLIST_META_KEY_BY_FETCHER, 'enrichFetcherKeys': sorted(ENRICH_FETCHER_KEYS), 'enrichReloadWishlistKeys': sorted(ENRICH_RELOAD_WISHLIST_KEYS), 'authProviderByKey': AUTH_PROVIDER_BY_KEY, 'noAutoFetchKeys': no_auto_fetch_keys()}
    lines = ['// Generated from fetchers/registry.py — keep in sync with manifest maps.', '// Regenerate: python -c "from fetchers.registry import export_js_registry; export_js_registry()"', '', f"export const LIBRARY_STORE_JSON = {json.dumps(payload['libraryStoreJson'], indent=2)};", '', f"export const WISHLIST_FETCHER_JSON = {json.dumps(payload['wishlistFetcherJson'], indent=2)};", '', f"export const WISHLIST_FETCHER_META_KEY = {json.dumps(payload['wishlistFetcherMetaKey'], indent=2)};", '', f"export const ENRICH_FETCHER_KEYS = new Set({json.dumps(payload['enrichFetcherKeys'])});", '', f"export const ENRICH_RELOAD_WISHLIST_KEYS = new Set({json.dumps(payload['enrichReloadWishlistKeys'])});", '', f"export const FETCHER_AUTH_PROVIDER = {json.dumps(payload['authProviderByKey'], indent=2)};", '', f"export const NO_AUTO_FETCH_KEYS = new Set({json.dumps(payload['noAutoFetchKeys'])});", '']
