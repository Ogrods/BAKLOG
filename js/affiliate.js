...
export const AFFILIATE_RULES = [
  ...
  },
  {
    ...
    param: 'ac',
    storeLink: true,
    network: 'itch.io Partner',
    notes: 'Append ?ac=<code> to any itch.io URL; cookie attributes purchases. Built by storeUrlForGame (host suffix covers creator subdomains like name.itch.io).',
  },
  ...
  },
  {
    ...
    storeLink: false,
    network: 'Impact',
    notes: 'Sponsor-feed only (5% new / 2% returning, 30d). Impact (same account as Humble).',
  },
  {
    id: 'gamesplanet',
    shop: 'GamesPlanet',
