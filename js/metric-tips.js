...
export const EYEBROW_TIPS = {
  ...
  'Critic darling': 'Metacritic 88+ and rated 75%+ - critics and players both approve.',
  'Deck ready': 'ProtonDB Platinum/Gold/Native and rated 75%+ - runs great on Steam Deck / Linux.',
  'Aged classic': 'Released 12+ years ago, rated 78%+ - a well-aged classic still in your backlog.',
...
export const EYEBROW_VARIANTS = {
  ...
  'Critic darling': ['Critic darling', 'Critics agree', 'Metacritic favorite', 'Award-tier'],
  'Deck ready': ['Deck ready', 'Deck verified', 'Runs on Deck', 'Linux-ready'],
  'Aged classic': ['Aged classic', 'Old but gold', 'Retro pick', 'Still kicking'],
