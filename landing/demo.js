...
(function () {
  ...
  const MARQUEE_ITEMS = [
    ...
    { icon: "F", cls: "is-sky", label: "Free", text: "<strong>12</strong> giveaways live", tip: "Never miss a free game again - Claimable Now aggregates active giveaways from Epic, GamerPower, and IsThereAnyDeal." },
