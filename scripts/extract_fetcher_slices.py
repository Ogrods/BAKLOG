...
slices = {
    "runner_body.txt": (1278, 3165),
    "render_dashboard.txt": (3370, 3754),
    "render_stats.txt": (3177, 3368),
    "global_indicator.txt": (910, 1129),
    "source_meta.txt": (513, 909),
    "freshness.txt": (1131, 1206),
    "misc.txt": (404, 512),
    "reconnect.txt": (87, 403),
}
