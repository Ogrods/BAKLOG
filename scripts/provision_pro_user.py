...
from shared.supabase_admin import create_user_by_email, delete_user_by_email, find_user_by_email, load_maintainer_env, set_user_plan
...
def main(argv: list[str] | None=None) -> int:
    ...
    parser.add_argument('--from-invitees', action='store_true', help='Provision every address in packaging/pro_invitees.txt.')
    parser.add_argument('--delete', action='store_true', help='Delete listed user(s) so Create account works again (requires --apply).')
