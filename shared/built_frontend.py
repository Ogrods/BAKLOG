...
from shared.install_paths import built_immutable_assets, built_manifest_path, bundle_root, is_frozen, load_built_manifest, serve_built_frontend
...
def maybe_serve_built_index(handler: SimpleHTTPRequestHandler, path_only: str) -> bool:
