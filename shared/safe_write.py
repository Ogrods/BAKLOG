...
def rotate_backup(path, *, backup_dir=None, prefix=None, keep=DEFAULT_KEEP):
    if not path.exists():
        return None
...
def safe_write_text(path, text, *, backup_dir=None, prefix=None, keep=DEFAULT_KEEP, encoding="utf-8"):
