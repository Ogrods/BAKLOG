...
def handle_mirror_get(handler):
    ...
    try:
        if artifact:
            ...
            srv._send_json(handler, HTTPStatus.OK, {"artifacts": artifacts, "localUploadState": local_state})
            return
...
def handle_mirror_import_post(handler):
    srv = _srv()
