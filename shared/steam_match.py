...
_SPINOFF_MARKERS = re.compile('\\b(director|artbook|soundtrack|wallpaper|dlc|upgrade|deluxe|bundle|pack|skin|ost|ascended|relaunched|reloaded)\\b')
...
def normalize_title(name: str) -> str:
    ...
    s = re.sub('[\\u2122\\u00ae\\u00a9]', '', s)
    s = re.sub('[^a-z0-9]+', ' ', s)
    s = re.sub('\\b(remastered|edition|complete|gold|definitive|enhanced|classic|goty|of the year|game of the year|special|standard|deluxe|collection|anthology|pack|the|hd|remake)\\b', ' ', s)
