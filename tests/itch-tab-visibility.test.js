...
// Prevent dynamic import of pro-view.js from leaking async callbacks after
// test environment teardown (applyProTabVisibility references document).
vi.mock("../js/pro-view.js", () => ({
  applyProTabVisibility: vi.fn(),
  renderProView: vi.fn(),
}));
