...
from auth.manager import _provider_state, disconnect, enable_local, is_local_provider_disabled
...
def test_disconnect_local_sets_disabled(monkeypatch):
...
def test_enable_local_clears_disabled(monkeypatch):
    monkeypatch.setattr("auth.manager.platform_supported", lambda platforms: True)
...
def test_provider_state_local_connected_when_sql_dir(monkeypatch, tmp_path):
    monkeypatch.setattr("auth.manager.platform_supported", lambda platforms: True)
