...
from clients.amazon_web_client import COLLECTION_URLS, GAMING_HOME_URL, LUNA_CLAIMS_URL, amazon_signin_url, classify_sniff_capture, collection_page_ready, collection_urls, filter_codeless_claims, is_luna_error_page, is_luna_hub, is_signin_url, needs_collection_redirect, on_collection_page, signed_in, try_parse_claims_from_html, try_parse_claims_from_text
...
def test_raw_dump_fallback_builds_records() -> None:
    raw_claim = {'itemTitle': 'Lake', 'itemId': 'amzn1.pg.item.lake', 'orderId': 'amzn1.pg.order.1', 'orderState': 'FULFILLED'}
