...
from auth.bundle import MAGIC, BadMagic, BadPassphrase, BundleTooLarge, UnsupportedVersion, export_bundle, import_bundle, parse_bundle_header
...
def test_roundtrip_credentials_only() -> None:
...
def test_roundtrip_with_profiles(_isolated_auth: Path) -> None:
...
def test_bad_passphrase_rejected() -> None:
...
def test_pre_import_snapshot_taken(_isolated_auth: Path) -> None:
