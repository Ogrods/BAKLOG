"""Tests for python -m auth expire (dev Reconnect chip testing)."""
...
def test_expire_list_returns_0(capsys: pytest.CaptureFixture[str]) -> None:
...
def test_expire_marks_connected_provider_expired() -> None:
