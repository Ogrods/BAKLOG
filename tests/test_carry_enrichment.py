"""Tests for fetchers._base.carry_enrichment."""

from fetchers._base import carry_enrichment


def test_copies_missing_fields_from_loser() -> None:
...
def test_does_not_clobber_winner_values() -> None:
...
def test_no_loser_returns_winner() -> None:
    winner = {"name": "X"}
