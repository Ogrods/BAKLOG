"""Optional live-profile EA session smoke test.

Run explicitly when a connected EA profile exists locally:

    pytest tests/test_ea_cdp_integration.py -m integration

Skip with BAKLOG_SKIP_CDP_INTEGRATION=1.
"""
