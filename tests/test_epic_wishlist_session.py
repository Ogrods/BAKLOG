...
from auth.epic_wishlist_session import cloudflare_interstitial, enrich_wishlist_elements_with_catalog, extract_catalog_offers_from_html, extract_wishlist_payloads_from_html, is_epic_graphql_url, storefront_auth_blocked, storefront_bounced_to_home, storefront_signed_out, wishlist_capture_complete_from_html, wishlist_graphql_ok
...
def test_wishlist_graphql_ok_accepts_batched_array() -> None:
    batch = [{'data': {'Wishlist': {'wishlistToast': {'offers': {'onSale': []}}}}}, {'data': {'Wishlist': {'wishlistItems': {'elements': [{'id': 'wish-1'}]}}}}]
