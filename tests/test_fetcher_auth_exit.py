...
AUTH_EXIT_SCRIPTS = ['fetchers/fetch_gog.py', 'fetchers/fetch_gog_wishlist.py', 'fetchers/fetch_psn.py', 'fetchers/fetch_psn_wishlist.py', 'fetchers/fetch_epic.py', 'fetchers/fetch_xbox.py', 'fetchers/fetch_battlenet.py', 'fetchers/fetch_nintendo.py', 'fetchers/fetch_ubisoft.py', 'fetchers/fetch_itch.py', 'fetchers/fetch_ea.py']
SESSION_AUTH_WISHLIST_SCRIPTS = ['fetchers/fetch_epic_wishlist.py', 'fetchers/fetch_xbox_wishlist.py', 'fetchers/fetch_ubisoft_wishlist.py', 'fetchers/fetch_nintendo_wishlist.py']
AUTH_EXIT_SCRIPTS_GENERIC = ['fetchers/fetch_amazon.py', 'fetchers/fetch_humble.py', 'fetchers/fetch_humble_wishlist.py', 'fetchers/fetch_games.py', 'fetchers/fetch_wishlist.py']
...
def test_auth_error_branches_use_exit_code_4(script: str) -> None:
    ...
    assert all((code == 'EXIT_CODE_AUTH' for code in blocks)), f'{script} AuthError branches must use exit_code=EXIT_CODE_AUTH, got {blocks}'
