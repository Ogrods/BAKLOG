...
def test_parse_branch_row_full():
    ...
    assert row == {'name': 'feature/x', 'sha': 'abc1234', 'upstream': 'origin/feature/x', 'date': '2026-06-10 10:00:00 -0700', 'subject': 'Do a thing'}
...
def test_render_fragment_escapes_script_close(monkeypatch):
    snapshot = {'generated_at': '2026-06-10T22:00:00-07:00', 'repo': 'steam-backlog', 'base': 'main', 'current': 'main', 'dirty': False, 'dirty_count': 0, 'branches': [{'name': 'main', 'sha': 'abc', 'subject': '</script> hack', 'date': '', 'upstream': '', 'ahead': 0, 'behind': 0, 'current': True}], 'commits': [], 'graph_text': '', 'prs': {'available': False, 'items': []}, 'max_commits': 300}
...
def test_render_fragment_escapes_quotes_in_script():
    snapshot = {'generated_at': '2026-06-10T22:00:00-07:00', 'repo': 'repo" onclick=alert(1)', 'base': 'main', 'current': 'main', 'dirty': False, 'dirty_count': 0, 'branches': [], 'commits': [], 'graph_text': '', 'prs': {'available': False, 'items': []}, 'max_commits': 300}
...
def test_render_fragment_script_placeholder_before_data():
    snapshot = {'generated_at': '2026-06-10T22:00:00-07:00', 'repo': '__SCRIPT__', 'base': 'main', 'current': 'main', 'dirty': False, 'dirty_count': 0, 'branches': [{'name': 'main', 'sha': 'abc', 'subject': 'ok', 'date': '', 'upstream': '', 'ahead': 0, 'behind': 0, 'current': True}], 'commits': [], 'graph_text': '', 'prs': {'available': False, 'items': []}, 'max_commits': 300}
    fragment = git_tree.render_fragment(snapshot)
...
def test_render_html_is_self_contained():
    snapshot = {'generated_at': '2026-06-10T22:00:00-07:00', 'repo': 'steam-backlog', 'base': 'main', 'current': 'main', 'dirty': False, 'dirty_count': 0, 'branches': [], 'commits': [], 'graph_text': '', 'prs': {'available': True, 'items': []}, 'max_commits': 300}
