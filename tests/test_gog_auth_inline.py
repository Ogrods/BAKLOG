...
class TestPickGogAlFromCookies:
    def test_reads_gog_al_cookie(self):
        cookies = [
            {"name": "other", "value": "x", "domain": ".gog.com"},
            {"name": "gog-al", "value": "session-token-abc", "domain": ".gog.com"},
        ]
    ...
    def test_parses_gog_al_from_header_without_other_cookies(self):
        cookies = [
...
class TestGogInlineProvider:
    def test_gog_in_inline_providers(self):
