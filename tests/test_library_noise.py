...
from shared.library_noise import catalog_game_count, edition_title_join_key, is_catalog_noise_row, is_nintendo_noise_row, maybe_tag_library_noise_row, should_auto_hide_by_title

def test_streaming_and_voucher_titles_auto_hide() -> None:
...
def test_edition_dedupe_key_not_noise() -> None:
...
def test_nintendo_dlc_without_app_is_noise() -> None:
    assert is_nintendo_noise_row({'name': 'Bonus Pack', 'tags': ['dlc']})

def test_nintendo_dlc_with_app_is_not_noise_by_metadata() -> None:
