...
class TestEpicAcquiredAt:
    ...
    def test_build_row_from_record_keeps_release_date_separate(self) -> None:
        rec = {'namespace': 'fn', 'catalogItemId': 'item-1', 'sandboxName': 'Fallback Game', 'acquisitionDate': '2023-01-15T00:00:00.000Z'}
    ...
    def test_catalog_row_gets_acquired_at_without_touching_release(self) -> None:
        ...
        catalog = {'title': 'Catalog Game', 'keyImages': [{'type': 'OfferImageWide', 'url': 'https://example/x.jpg'}], 'categories': [{'path': 'games'}], 'releaseInfo': [{'date': '2020-01-01T00:00:00.000Z'}]}
