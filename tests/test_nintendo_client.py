...
import pytest
from clients.nintendo_client import NintendoAuthError, NintendoCaptureError, NintendoClient, _drain_graphql_candidates, _map_graphql_item, probe_session_id_token

def test_map_graphql_item_maps_switch_platform() -> None:
    row = _map_graphql_item({'title': 'Bleak Sword DX', 'datetime': '2026-04-08T00:14:57-07:00', 'transactionId': 52378618743, 'labelPlatform': 'HAC', 'itemType': 'APPLICATION', 'transactionType': 'PURCHASE'})
...
def test_drain_graphql_candidates_parses_on_main_thread() -> None:
    sample_payload = {'data': {'account': {'transactionHistories': {'transactionHistories': [{'title': 'Iconoclasts', 'datetime': '2025-09-05T12:00:00-07:00', 'transactionId': 51988550814, 'labelPlatform': 'HAC', 'itemType': 'APPLICATION', 'transactionType': 'PURCHASE'}]}}}}
...
def test_direct_graphql_continues_past_duplicate_page(monkeypatch) -> None:
    page_one = {'data': {'account': {'transactionHistories': {'transactionHistories': [{'title': 'Iconoclasts', 'datetime': '2025-09-05T12:00:00-07:00', 'transactionId': 51988550814, 'labelPlatform': 'HAC', 'itemType': 'APPLICATION', 'transactionType': 'PURCHASE'}]}}}}
    page_two = {'data': {'account': {'transactionHistories': {'transactionHistories': [{'title': 'Wargroove', 'datetime': '2025-08-01T12:00:00-07:00', 'transactionId': 51999999999, 'labelPlatform': 'HAC', 'itemType': 'APPLICATION', 'transactionType': 'PURCHASE'}]}}}}
