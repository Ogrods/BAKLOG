...
def test_parse_wishlist_from_next_data_fixture():
...
def test_wishlist_item_is_dlc_from_product_type():
...
def test_signed_out_login_page():
...
def test_parse_wishlist_from_graphql_payload():
    payload = {
        "data": {
            "customer": {
                "id": "cust-1",
...
def test_empty_authenticated_wishlist_counts_as_session():
