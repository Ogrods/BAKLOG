...
def test_create_profile_migrates_default_copy(isolated_profiles: Path) -> None:
    (isolated_profiles / 'games_steam.json').write_text('{"game_count":1,"games":[{"id":"1","name":"A"}]}', encoding='utf-8')
...
def test_finalize_migration_when_default_dir_exists_without_marker(isolated_profiles: Path) -> None:
