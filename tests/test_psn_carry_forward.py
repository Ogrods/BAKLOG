...
def test_apply_psn_carry_forward_prunes_stale_id_churn_sibling():
...
def test_prune_stale_psn_duplicates_repair():
    games = [
        {"id": "NPWR39259_00", "name": "SONIC X SHADOW GENERATIONS"},
        {"id": "PPSA17597_00", "name": "SONIC X SHADOW GENERATIONS", STALE_FIELD: True},
