...
def test_apply_psn_carry_forward_prunes_stale_id_churn_sibling() -> None:
    fresh = [{'id': 'NPWR42480_00', 'name': 'Warhammer 40,000: Darktide', 'psn_platforms': ['PS5']}]
    existing = {'PPSA21255_00': {'id': 'PPSA21255_00', 'name': 'Warhammer 40,000: Darktide', 'psn_platforms': ['PS5'], STALE_FIELD: True}}
...
def test_prune_stale_psn_duplicates_repair() -> None:
    games = [{'id': 'NPWR39259_00', 'name': 'SONIC X SHADOW GENERATIONS'}, {'id': 'PPSA17597_00', 'name': 'SONIC X SHADOW GENERATIONS', STALE_FIELD: True}, {'id': 'PPSA28176_00', 'name': 'Battlefield 6', STALE_FIELD: True}]
