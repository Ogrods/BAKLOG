...
def server_mod(monkeypatch, tmp_path):
    dist = tmp_path / 'dist'
    dist.mkdir()
    (dist / 'manifest.json').write_text('{"tailwind.css":"tailwind.AAAA.css","app.css":"app.BBBB.css","js/app.js":"js/app-CCCC.js","js/chunks":[]}', encoding='utf-8')
    index = tmp_path / 'index.html'
    index.write_text('<link rel="stylesheet" href="tailwind.css" />\n<link rel="stylesheet" href="app.css" />\n<script type="module" src="js/app.js"></script>\n', encoding='utf-8')
...
def test_built_index_invalidates_when_manifest_changes(server_mod, tmp_path):
    ...
    dist = tmp_path / 'dist'
    (dist / 'manifest.json').write_text('{"tailwind.css":"tailwind.AAAA.css","app.css":"app.BBBB.css","js/app.js":"js/app-DDDD.js","js/chunks":[]}', encoding='utf-8')
    import shared.install_paths as ip
    ip._BUILT_MANIFEST_CACHE = None
    ip._BUILT_MANIFEST_MTIME_NS = None
    import shared.built_frontend as bf
