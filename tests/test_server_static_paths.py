...
@pytest.mark.parametrize('path,expected', [('/tracker.html', 'deny'), ('/TRACKER.HTML', 'deny'), ('/tracker%2ehtml', 'deny'), ('/.env', 'deny'), ('/%2eenv', 'deny'), ('/profiles/default/data/personal.json', 'deny'), ('/Profiles/default/data/personal.json', 'deny'), ('/cache/auth/secrets.bin', 'deny'), ('/Cache/auth/secrets.bin', 'deny'), ('/games_steam.json', 'data'), ('/free_claims.json', 'data'), ('/index.html', 'public'), ('/js/app.js', 'public')])
