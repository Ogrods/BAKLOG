...
from auth.session_probe import PROBEABLE_QUIET, probe_browser_session, probe_epic_session_quiet, probe_gog_session, probe_gog_session_quiet, probe_itad_session_quiet, probe_itch_session_quiet, probe_provider_quiet, probe_steam_session_quiet, probe_xbox_wishlist_session
...
class TestProbeXboxWishlistSession:
    ...
    def test_capture_failure_surfaces(self) -> None:
        with patch('auth.xbox_wishlist_session.capture_xbox_wishlist_preloaded_state', side_effect=RuntimeError('profile missing')):
