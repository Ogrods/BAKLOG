...
class FakePage:
    ...
    def __init__(self, *, inline_steamid: bool=False, has_key: bool=False, rate_limit_after: int=4) -> None:
        self.url = APIKEY_URL
...
class FakeContext:
    ...
    def cookies(self):
        ...
        return [{'name': 'sessionid', 'value': 'x', 'domain': 'steamcommunity.com'}, {'name': 'steamLoginSecure', 'value': f'{self._steamid}{token}', 'domain': 'steamcommunity.com'}]
