...
def test_related_pids_includes_ancestors_and_descendants(monkeypatch):
...
@pytest.mark.skipif(sys.platform != "win32", reason="Windows job object")
def test_job_popen_child_terminated_on_close():
    proc = popen_fetcher(
