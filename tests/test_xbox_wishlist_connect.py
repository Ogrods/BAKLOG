...
def test_xbox_url_on_wishlist_ignores_oauth_redirect_uri():
...
def test_xbox_url_on_wishlist_matches_real_wishlist_path():
...
def test_xbox_has_msa_session_detects_wlssc_and_xb_tokens():
