...
GAMES = (('neon-drift', 'Neon Drift', 'portrait', '#38bdf8'), ('vault-runner', 'Vault Runner', 'landscape', '#22d3ee'), ('couch-quest', 'Couch Quest', 'portrait', '#a855f7'), ('sale-signal', 'Sale Signal', 'landscape', '#6ee7b7'), ('hidden-circuit', 'Hidden Circuit', 'portrait', '#f472b6'), ('quick-byte', 'Quick Byte', 'portrait', '#fbbf24'), ('coop-cascade', 'Coop Cascade', 'portrait', '#34d399'), ('new-signal', 'New Signal', 'landscape', '#60a5fa'), ('replay-loop', 'Replay Loop', 'portrait', '#c4b5fd'), ('up-next', 'Up Next', 'portrait', '#38bdf8'), ('crit-acclaim', 'Crit Acclaim', 'landscape', '#22d3ee'), ('barrel-roll', 'Barrel Roll', 'portrait', '#f97316'))
BG_TOP = (15, 23, 42)
BG_BOT = (8, 14, 30)
